    ...
    return this.prisma.$transaction(async (tx) => {
      const product = await tx.product.create({
        data: {
          ...
          currencyOrigin: createProductDto.currencyOrigin || 'USD',
          costPriceVES: createProductDto.costPriceVES !== undefined ? createProductDto.costPriceVES : null,
          salePriceVES: createProductDto.salePriceVES !== undefined ? createProductDto.salePriceVES : null,
        ...
        if (initialStock > 0) {
          await tx.stockMovement.create({
            data: {
              ...
              previousQty: 0,
              newQty: initialStock,
              costUnitUSD: createProductDto.costPriceUSD,
              costUnitVES: createProductDto.costPriceVES,
  ...
  async update(id: string, updateProductDto: UpdateProductDto, tenantId: string) {
    ...
    return this.prisma.product.update({
      ...
      data: {
        ...
        currencyOrigin: updateProductDto.currencyOrigin,
        costPriceVES: updateProductDto.costPriceVES,
        salePriceVES: updateProductDto.salePriceVES,
